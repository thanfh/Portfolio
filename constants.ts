...
export const PROFILE: Profile = {
  ...
  socials: [
    // Adding missing id property to comply with SocialLink interface
...
// Added PROFILE_VI to support the multi-language context defined in LanguageContext.tsx
...
export const UI_TEXT = {
  ...
  draft_title: "DRAFT",
  draft_lab: "Experimental Lab",
  draft_description: "A collection of daily drills, unused concepts, and visual experiments. Where function takes a backseat to form.",
...
export const DICTIONARY = {
  en: UI_TEXT,
  vi: { ...UI_TEXT } // English only as per user request
};
